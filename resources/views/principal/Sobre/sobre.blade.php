...
@section('nav')
@include('principal.layout.Nav.nav_sobre')
@endsection
      ...
      <div class="row">
        <div class="col-md-4 col-lg-3 mb-4 mb-md-0">
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3><a href="tel:454545654">+244 935-460-590</a></h3>
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3><a href="mailto:support@colorlib.com">support@spaac.com</a></h3>
