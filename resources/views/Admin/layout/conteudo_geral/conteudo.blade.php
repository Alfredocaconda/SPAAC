<div id="content">
         @section('top_bar')
         @include('Admin.layout.Top_bar.top_bar')
         @endsection
               <!-- dashboard inner -->
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="{{url('template_admin/images/autores/autor.jpg')}}" alt=""></div>
                                                ...
                                                <div class="item carousel-item">
                                                   <div class="img-box"><img src="{{url('template_admin/images/autores/autor1.jpg')}}" alt=""></div>
                                                   <p class="testimonial">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae..</p>
                                                   <p class="overview"><b>Michael Stuart</b>Seo Founder</p>
                                                </div>
                                                <div class="item carousel-item">
                                                   <div class="img-box"><img src="{{url('template_admin/images/autores/autor3.jpg')}}" alt=""></div>
                                                   <p class="testimonial">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae..</p>
                                                   <p class="overview"><b>Michael Stuart</b>Seo Founder</p>
                                                </div>
                                             </div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="{{url('template_admin/images/comentarios/jelson.jpg')}}" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="{{url('template_admin/images/comentarios/paulo.jpg')}}" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="{{url('template_admin/images/comentarios/Sany 2.png')}}" class="img-responsive" alt="#" /></span>
                                          <span>
                                          <span class="name_user">John Smith</span>
                                          <span class="msg_user">On the other hand, we denounce.</span>
                                          <span class="time_ago">12 min ago</span>
