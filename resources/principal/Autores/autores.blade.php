      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item active"><a class="nav-link" href="archive.html">Autores</a></li> 
              <li class="nav-item"><a class="nav-link" href="category.html">Artigos</a>
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                  aria-expanded="false">Monografia</a>
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="blog-details.html">Monografia mais lido</a></li>
                </ul>
              </li>
