            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  ...
                  <div class="logo_section">
                        <a href="index.html"><img class="logo_icon img-responsive" src="{{url('tamplate_admin/images/logo/logo_icon.png')}}" alt="#" /></a>
                     </div>
                  </div>
                  <div class="sidebar_user_info">
                     <div class="icon_setting"></div>
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="{{url('template_admin/images/layout_img/user_img.jpg')}}" alt="#" /></div>
                        <div class="user_info">
                           <h6>John David</h6>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="index.html"><img class="img-responsive" src="{{url('template_admin/images/logo/logo.png')}}" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="{{url('template_admin/images/layout_img/user_img.jpg')}}" alt="#" /><span class="name_user">John David</span></a>
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="{{url('template_admin/images/layout_img/user_img.jpg')}}" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="{{url('template_admin/images/layout_img/msg2.png')}}" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="{{url('template_admin/images/layout_img/msg3.png')}}" class="img-responsive" alt="#" /></span>
                                          <span>
