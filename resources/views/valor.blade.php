...
<html lang="en">
   <head>
      ...
      <!-- site icon -->
      <link rel="icon" href="{{url('template_admin/images/fevicon.png')}}" type="image/png" />
      <!-- bootstrap css -->
      <link rel="stylesheet" href="{{url('tamplate_admin/css/bootstrap.min.css')}}" />
      <!-- site css -->
      <link rel="stylesheet" href="{{url('tamplate_admin/style.css')}}" />
      <!-- responsive css -->
      <link rel="stylesheet" href="{{url('tamplate_admin/css/responsive.css')}}" />
      <!-- color css -->
      <link rel="stylesheet" href="{{url('tamplate_admin/css/colors.css')}}" />
      <!-- select bootstrap -->
      <link rel="stylesheet" href="{{url('tamplate_admin/css/bootstrap-select.css')}}" />
      <!-- scrollbar css -->
      <link rel="stylesheet" href="{{url('tamplate_admin/css/perfect-scrollbar.css')}}" />
      <!-- custom css -->
      <link rel="stylesheet" href="{{url('tamplate_admin/css/custom.css')}}" />
      <!--[if lt IE 9]>
   ...
   <body class="dashboard dashboard_1">
      ...
      <!-- jQuery -->
      <script src="{{url('tamplate_admin/js/jquery.min.js')}}"></script>
      <script src="{{url('tamplate_admin/js/popper.min.js')}}"></script>
      <script src="{{url('tamplate_admin/js/bootstrap.min.js')}}"></script>
      <!-- wow animation -->
      <script src="{{url('tamplate_admin/js/animate.js')}}"></script>
      <!-- select country -->
      <script src="{{url('tamplate_admin/js/bootstrap-select.js')}}"></script>
      <!-- owl carousel -->
      <script src="{{url('tamplate_admin/js/owl.carousel.js')}}"></script> 
      <!-- chart js -->
      <script src="{{url('tamplate_admin/js/Chart.min.js')}}"></script>
      <script src="{{url('tamplate_admin/js/Chart.bundle.min.js')}}"></script>
      <script src="{{url('tamplate_admin/js/utils.js')}}"></script>
      <script src="{{url('tamplate_admin/js/analyser.js')}}"></script>
      <!-- nice scrollbar -->
      <script src="{{url('tamplate_admin/js/perfect-scrollbar.min.js')}}"></script>
      <script>
         var ps = new PerfectScrollbar('#sidebar');
      </script>
      <!-- custom js -->
      <script src="{{url('tamplate_admin/js/custom.js')}}"></script>
      <script src="{{url('tamplate_admin/js/chart_custom_style1.js')}}"></script>
   </body>
</html>